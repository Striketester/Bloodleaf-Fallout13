...
/*
	...
	GLOB.breasts_size_list = list ("a", "b", "c", "d", "e")//  None-selectable through menu "f" "g", "h", "i", "j", "k", "l", "m", "n", "o") //We need the list to choose from initialized, but it's no longer a sprite_accessory thing.
